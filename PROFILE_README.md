...
- Data engineering pipelines with orchestration, transformations, data quality checks, and warehouse modeling.
- AI systems with retrieval evaluation, prompt/version tracking, and observable failure modes.
- ML services with training, serving, monitoring, and retraining workflows.
